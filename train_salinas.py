...
def classification_map(map, ground_truth, dpi, save_path):
    ...
    fig.set_size_inches(ground_truth.shape[1] * 3.0 / dpi,
                        ground_truth.shape[0] * 3.0 / dpi)
...
if __name__ == '__main__':
    ...
    im_mat = loadmat('./salinas/Salinas_corrected.mat')
    ...
    im = torch.from_numpy(im).unsqueeze(dim=0).to(torch.device("cuda:0"))
    ...
    outputs = y_pred.numpy()[0:512, 0:217]
