...
class NewPaviaDataset(FullImageDataset):
    def __init__(self,
        ...
        image = im_mat['paviaU']  # (610, 340, 103)
        gt_mat = loadmat(gt_mat_path)
        mask = gt_mat['paviaU_gt']  # (610, 340)
        ...
        super(NewPaviaDataset, self).__init__(image, mask, training, sample_percent=sample_percent, batch_size=batch_size)
